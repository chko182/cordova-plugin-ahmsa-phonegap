...
//#define AFARIA_BUNDLE_ID @"Personal.VPN-TEST"
...
#define kInvalidSignature				14
#define kValidBundleID					15
...
- (void)didFailSeedWithError:(NSError *)error;
...
+(NSInteger) initializeLibrary:(NSURL *) url inUrlScheme:(NSString *)inurlscheme forceSigning:(BOOL) forceValidSigning withBundleID:(NSString *)bundleID;
+(NSInteger) initializeLibrary:(NSURL *) url inUrlScheme:(NSString *)inurlscheme withBundleID:(NSString *)bundleID;
